...
class ResponsableV {
    ...
    public function __toString(){
        return "numeroDeEmpleado: ".$this->getNumeroDeEmpleado()."\n".
        "numeroDeLicencia: ".$this->getNumeroDeLicencia()."\n".
        "Cantidad maxima de pasajeros: ".$this->getNombre()."\n".
        "Pasajeros: ".$this->getApellido();
        }
